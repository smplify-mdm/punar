...
| 3b | Versioned typed PIM IPC/schema, ownership/pagination/change cursors/offline/conflict negative fixtures | **contract, bounded/authorized parser and signed cursor primitive complete; durable key injection + store dispatcher open** |
