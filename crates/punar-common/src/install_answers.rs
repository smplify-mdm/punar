...
mod tests {
    ...
    fn fixture() -> (UnattendedInstallAnswers, InstallPlan) {
        let plan = InstallPlan {
            ...
            recovery_payload: Some(InstallPayloadPlan {
                release_id: "punar-desktop-2026.09.01.1".into(),
                filename: "slot-b.raw.zst".into(),
                digest_sha256: "5".repeat(64),
                compressed_size_bytes: 1,
                uncompressed_digest_sha256: "6".repeat(64),
                uncompressed_size_bytes: 2,
            }),
            recovery_boot_artifact: Some(InstallBootArtifactPlan {
                kind: BootArtifactKind::Uki,
                filename: "slot-b.efi".into(),
                digest_sha256: "7".repeat(64),
                size_bytes: 3,
            }),
            partitions: vec![],
