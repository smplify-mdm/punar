...
MANIFEST: list[tuple[str, str | None]] = [
    ...
    ("schemas/install/examples/hardware-report*", "schemas/install/hardware-report.json"),
    ("schemas/install/examples/install-answers*", "schemas/install/answers.json"),
    ("schemas/install/examples/install-custody*", "schemas/install/custody.json"),
    ...
    ("fixtures/install/*/hardware-report*", "schemas/install/hardware-report.json"),
    ("fixtures/install/*/install-answers*", "schemas/install/answers.json"),
    ("fixtures/install/*/install-custody*", "schemas/install/custody.json"),
