...
<!-- Punar wallpaper plate: {plate['place']}, {plate['region']}.
     ...
     gradient, no filter, no <text>, no animation, no script. The corner type is
     Geist Mono converted to outlines here, so the plate renders correctly
     before any font is loaded. -->
