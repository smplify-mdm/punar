...
| 3b | Versioned typed PIM IPC/schema, ownership/pagination/change cursors/offline/conflict negative fixtures | **contract, bounded/authorized parser and durable private signed-cursor key complete; store dispatcher open** |
